...
- [v27.7.md](v27.7.md) — BUG-013 fix (estimate classifier: all undiagnosed symptom families route to diagnostic; diagnostic reframed as first step with fee waiver). Generated from verified live V27.6; NOT DEPLOYED until imported. **Current version on deploy.**
