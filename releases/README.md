...
- [v27.9.md](v27.9.md) — BUG-014 matcher-confidence guard (weak/ambiguous match no longer prices a repair for an undiagnosed symptom; invented-price 4->0, 0 regressions). Generated from verified live V27.8; NOT DEPLOYED until imported. **Current version on deploy.**
- [v27.8.md](v27.8.md) — BUG-016 fix (BUG-013 follow-up: symptom lexicon extended for natural-language variants; 4 live-QA criticals eliminated). Generated from verified live V27.7; NOT DEPLOYED until imported. (superseded by v27.9).
