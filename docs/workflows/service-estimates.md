...
This workflow is pricing-only (V26.7): scheduling flows resolve service duration from the catalog themselves and never call this workflow just to obtain a duration.
