...
- Duration: when the AI supplies no estimatedMinutes — or supplies the 90-minute "unknown" sentinel (V26.8) — the stored Duration Minutes of the appointment being moved is used, so a 5-hour job keeps a 5-hour slot when rescheduled.
