...
| [BUG-009](BUG-009.md) | Return Customer Lookup ignores the active session phone and falls back to the parent workflow placeholder phone | High | Open | Lookup searches with the parent-workflow placeholder phone instead of the valid active-session phone (evidence: session `14372415892`, parent `+16135551212`, `searchedPhone = 6135551212`). Root cause: Unknown — requires investigation. |
